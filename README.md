...
**`git clone https://github.com/shawnmanuel000/MultiAgentTennis.git`**
...
3. Place the file in the DRLND GitHub repository, in the root directory of the cloned repository, and unzip (or decompress) the file. 
